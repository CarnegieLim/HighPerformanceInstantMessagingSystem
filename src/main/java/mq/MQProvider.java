...
public class MQProvider {
    ...
    public MQProvider(String mqURI, String publishToQueue, String consumeFromQueue, String TAG, boolean publishTrayAgainEnable) {
        this(mqURI, publishToQueue, consumeFromQueue, null, null, TAG, publishTrayAgainEnable);
    }

    public MQProvider(String mqURI, String publishToQueue, String consumeFromQueue
        ...
        if (this.publishToQueue == null && this.consumeFromQueue == null) {
            throw new IllegalArgumentException("[" + TAG + "]无效的参数，publishToQueue和" +
                    "consumeFromQueue至少应设置其一！");
        }
